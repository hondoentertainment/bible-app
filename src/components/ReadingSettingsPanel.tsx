...
export function ReadingSettingsPanel() {
  ...
  return (
    <div className="fixed right-4 bottom-4 z-50 safe-bottom">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
      ...
      {open && (
        <div className="absolute right-0 bottom-14 w-72 rounded-2xl border border-parchment-dark bg-white p-4 shadow-xl">
